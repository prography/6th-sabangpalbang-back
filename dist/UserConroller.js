...
let _dec; let _dec2; let _dec3; let _class; let _class2
...
const _require = require('routing-controllers')
const JsonController = _require.JsonController
const Param = _require.Param
const Body = _require.Body
const Get = _require.Get
const Post = _require.Post
const Put = _require.Put
const Delete = _require.Delete

const UserController = (_dec = JsonController(), _dec2 = Get('/users'), _dec3 = Post('/users'), _dec(_class = (_class2 = /* #__PURE__*/function() {
